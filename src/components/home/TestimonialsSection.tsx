...
const testimonials = [
  ...
  },
  {
    ...
    content: "The mobile app they built for us exceeded all expectations. Professional team, clear communication, and delivered on time. Highly recommended!",
    rating: 5,
  },
  {
    id: 3,
    ...
    content: "Their AI integration solutions automated 60% of our customer service inquiries. The ROI was visible within the first month of deployment.",
    rating: 5,
  },
];
